...
PyCPG
===
    Code to read cgp files without needing the python wrapping from the original
    CGP code that brings hdf5-library in a state where it crashes when opening files with
    h5py.
"""
